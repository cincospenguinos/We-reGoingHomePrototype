...
export const ANIMS = {
	...
	room: {
		...
		playerMoveEast: {
			...
			repeat: 0,
			frames: [
				{ key: SPRITES.roomPlayer.key, frame: 10 },
				{ key: SPRITES.roomPlayer.key, frame: 11 },
				{ key: SPRITES.roomPlayer.key, frame: 12 },
				{ key: SPRITES.roomPlayer.key, frame: 13 },
				{ key: SPRITES.roomPlayer.key, frame: 14 },
				{ key: SPRITES.roomPlayer.key, frame: 15 },
				{ key: SPRITES.roomPlayer.key, frame: 16 },
			],
		},
		playerMoveSouth: {
			key: 'playerMoveSouth',
			...
			repeat: 0,
			frames: [
				{ key: SPRITES.roomPlayer.key, frame: 0 },
				{ key: SPRITES.roomPlayer.key, frame: 1 },
				{ key: SPRITES.roomPlayer.key, frame: 2 },
				{ key: SPRITES.roomPlayer.key, frame: 3 },
				{ key: SPRITES.roomPlayer.key, frame: 4 },
				{ key: SPRITES.roomPlayer.key, frame: 5 },
				{ key: SPRITES.roomPlayer.key, frame: 6 },
			],
		},
		playerMoveWest: {
			key: 'playerMoveWest',
			...
			repeat: 0,
			frames: [
				{ key: SPRITES.roomPlayer.key, frame: 30 },
				{ key: SPRITES.roomPlayer.key, frame: 31 },
				{ key: SPRITES.roomPlayer.key, frame: 32 },
				{ key: SPRITES.roomPlayer.key, frame: 33 },
				{ key: SPRITES.roomPlayer.key, frame: 34 },
				{ key: SPRITES.roomPlayer.key, frame: 35 },
				{ key: SPRITES.roomPlayer.key, frame: 36 },
			],
		},
		playerMoveNorth: {
			key: 'playerMoveNorth',
			...
			repeat: 0,
			frames: [
				{ key: SPRITES.roomPlayer.key, frame: 20 },
				{ key: SPRITES.roomPlayer.key, frame: 21 },
				{ key: SPRITES.roomPlayer.key, frame: 22 },
				{ key: SPRITES.roomPlayer.key, frame: 23 },
				{ key: SPRITES.roomPlayer.key, frame: 24 },
				{ key: SPRITES.roomPlayer.key, frame: 25 },
				{ key: SPRITES.roomPlayer.key, frame: 26 },
			],
		},
	},
};
